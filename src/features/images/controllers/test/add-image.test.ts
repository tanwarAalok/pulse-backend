...
describe('Add', () => {
  ...
  describe('profileImage', () => {
    it('should call image upload method', async () => {
      ...
      await AddImageController.prototype.profileImage(req, res);
  ...
  describe('backgroundImage', () => {
    it('should upload new image', async () => {
      ...
      await AddImageController.prototype.backgroundImage(req, res);
    ...
    it('should return bad request error', async () => {
      ...
      AddImageController.prototype.backgroundImage(req, res).catch((error: CustomError) => {
