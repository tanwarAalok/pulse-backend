...
describe('Get', () => {
  ...
  describe('userFollowing', () => {
    it('should send correct json response if user following exist in cache', async () => {
      ...
      await GetFollowersController.prototype.userFollowings(req, res);
      expect(FollowerCache.prototype.getFollowersFromCache).toBeCalledWith(`followings:${req.currentUser?.userId}`);
  ...
  describe('userFollowers', () => {
    it('should send correct json response if user follower exist in cache', async () => {
      ...
      await GetFollowersController.prototype.userFollowers(req, res);
