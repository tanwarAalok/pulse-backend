...
export class BlockUserController {
    public async block(req: Request, res: Response): Promise<void> {
        ...
        BlockUserController.prototype.updateBlockedUser(followerId, req.currentUser!.userId, 'block');
    ...
    public async unblock(req: Request, res: Response): Promise<void> {
        const { followerId } = req.params;
        BlockUserController.prototype.updateBlockedUser(followerId, req.currentUser!.userId, 'unblock');
