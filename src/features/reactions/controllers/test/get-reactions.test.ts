...
describe('Get', () => {
  ...
  describe('reactions', () => {
    it('should send correct json response if reactions exist in cache', async () => {
      ...
      await GetReactionController.prototype.getReactions(req, res);
  ...
  describe('singleReactionByUsername', () => {
    it('should send correct json response if reactions exist in cache', async () => {
      ...
      await GetReactionController.prototype.getSingleReactionByUsername(req, res);
  ...
  describe('reactionsByUsername', () => {
    it('should send correct json response if reactions exist in database', async () => {
      ...
      await GetReactionController.prototype.getReactionsByUsername(req, res);
